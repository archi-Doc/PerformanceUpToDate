...
public class ByteCompareTest2
{
    ...
    {
        return this.doublePositiveInfinityByte.AsSpan().SequenceEqual(TrueSpan);
    }

    [Benchmark]
    public bool LengthAndSequenceEqual()
    {
        var span = this.doublePositiveInfinityByte.AsSpan();
        return span.Length == TrueSpan.Length && span.SequenceEqual(TrueSpan);
    }
}
